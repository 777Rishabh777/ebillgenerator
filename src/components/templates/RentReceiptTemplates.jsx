    ...
    <div className="template-workspace">
      ...
      <div className="template-form-column compact-form">
        ...
        <div className="compact-form-section">
          ...
          <div className="compact-form-grid">
            ...
            <div className="compact-form-field" style={{ gridColumn: 'span 2' }}>
              <label className="compact-form-label">Custom Description (Optional)</label>
              <textarea
                ...
                rows="2"
                maxLength={500}
                placeholder="Write any custom note for this receipt..."
              />
            </div>
          </div>
        </div>
        ...
        <div className="compact-form-section">
          ...
          <div className="compact-form-grid">
            ...
            <div className="compact-form-field">
              <label className="compact-form-label">Paper Size</label>
              <select name="paperSize" value={formData.paperSize} onChange={handleInputChange} className="compact-form-input">
                <option value="A4">A4 (Long)</option>
                <option value="Letter">Letter</option>
                <option value="Legal">Legal (Extra Long)</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <DownloadModal
        ...
        billData={{
          ...
          vendorName: formData.landlordName,
          vendorPAN: formData.landlordPAN,
          ...
          quantity: 1,
          total: formData.rentAmount,
          paymentMethod: formData.paymentMethod,
          date: formData.receiptDate,
          description: formData.customDescription?.trim() || `Rent for ${formData.periodFrom} to ${formData.periodTo}`,
